...
constants.defaults.project.PROJECT_DIRECTORY = path.resolve(__dirname, '../projects');
constants.defaults.project.TEMPLATE_DIRECTORY = path.resolve(__dirname, './templates');
...
constants.defaults.project.ZULU_FILE_TEMPLATE_FILEPATH = path.resolve(constants.defaults.project.TEMPLATE_DIRECTORY, './zulu.json');
