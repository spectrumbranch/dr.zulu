        ...
        if (saveErr) {
            ...
            function(err, resultCluster) {
                if (err) {
                    ...
                    //TODO render all the templates to the project's folder
                    generator.writeFileCluster(resultCluster, function(fileWriteErr, fileWriteResults) {
